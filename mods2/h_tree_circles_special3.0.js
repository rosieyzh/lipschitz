...
function draw() {
    ...
    add_length2 = (cos(frameCount*PI/20)+1)/4+1/2;
	skew = (sin(frameCount*PI/23)+1)*PI/8;
    skew2 = (-sin(frameCount*PI/10)+1)*PI/8;
	...
	n=140.0;
    m=15.0; // no of frames to complete a wave
	translate(width/2, height-500);

    rotate(PI*sin(frameCount/50));
	stroke(255);

    translate(0,-150*sin(frameCount/m));
    translate(0,100);
	branch(n);
    translate(0,150*sin(frameCount/m));
    translate(0,-100);
